...
class UserContextSerializer(serializers.Serializer):
    ...
    company_gst_number = serializers.CharField(allow_null=True, required=False)
    company_cin = serializers.CharField(allow_null=True, required=False)
    company_registered_address = serializers.CharField(allow_null=True, required=False)
...
class RegisterRequestSerializer(serializers.Serializer):
    ...
    company_gst_number = serializers.CharField(required=False, allow_blank=True)
    company_cin = serializers.CharField(required=False, allow_blank=True)
    company_registered_address = serializers.CharField(required=False, allow_blank=True)
